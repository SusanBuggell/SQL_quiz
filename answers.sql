...
SELECT common_name, price FROM melons WHERE price>5.00 AND melon_type LIKE '%ater%';
...
SELECT melon_type, common_name, price AS USD, price*0.73 AS EUR FROM melons;
...
SELECT COUNT (id) FROM orders WHERE shipto_state LIKE '%CA%';
